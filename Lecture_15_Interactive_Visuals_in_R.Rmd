...
- This is all JS based - these tools translate immediately to Python (which also uses them via JS)
...
- You can adjust the width with `width_svg` and `height_svg` in the `girafe()` function, but it's not perfect
...
- Let's take what we know is feasible about these dashboards and make one with AI
- Emphasizing that we want an *interactive flexdashboard in R*...
- Go here and look for the "University" data: [https://vincentarelbundock.github.io/Rdatasets/datasets.html](https://vincentarelbundock.github.io/Rdatasets/datasets.html)
- Read the documentation and get the URL to the data set
- Consider some useful analyses you'd want on a dashboard, as well as some useful interaction
- Being very specific, prompt an AI to put together your dashboard
- Test and iterate
