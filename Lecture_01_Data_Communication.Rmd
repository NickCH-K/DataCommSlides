...
-   That's because this is *really* a course about preparing you to go out into the real world and work with data, in a world with AI
...
-   It really is just **thinking carefully** and **attending to detail**, not technical skill. This is more important than coding. We'll have to do some code, but code can only be as good as what you're trying to make it do
...
-   I want you to build enough confidence in working with data that you can look at something the computer or AI has spit out and think "the computer only does what it's told. I know what this *should* be. This is not yet right."
...
2.  Did it **work properly**? How can I **CHECK** if it worked properly?
3.  If it's a form of communication, have you made it **as clear as possible**? Try to find places where people might get confused.
...
2.  Figure out *the story* (what you want the reader to understand, and why)
