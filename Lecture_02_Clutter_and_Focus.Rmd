...
```{r}
knitr::include_graphics('Lecture_02_Bible_Cross_Ref.gif')
```
...
```{r}
knitr::include_graphics('Lecture_02_Network_Graph.jpg')
```
...
- Basically all good visualizations are about *making a comparison*. Here's one way you can show people *what comparison they're supposed to make
...
- Think: what is the *comparison* we want to encourage, and can we see it on your graph?
