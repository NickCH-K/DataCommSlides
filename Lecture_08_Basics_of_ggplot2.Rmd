...
- (also runs in Python using **plotnine**, so everything you learn here will also teach you plotting in Python)
...
- `alpha`: Transparency
- `linetype`: for lines or outlines, the type of line (solid, dashed...)
