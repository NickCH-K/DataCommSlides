...
-   Don't be so proud of your ability to code something up, or delighted at the ease of getting AI to produce something, that you forget to make the product good!
...
## Stories Usually Need a Comparison

-   Most data analyses that say something useful invite us to *compare* things
-   Number A is higher than number B, or higher than it used to be, or more dispersed over here than over there
-   Different geometries help us more easily show different kinds of comparisons
...
-   What does each invite us to compare?
...
-   More coloring and customization with `ggtexttable` in **ggpubr** (note this makes the table as an image) or the highly flexible **gt** package
...
![Map-based state heatmap](Lecture_12_State_Heatmap.png){width="560"}

## Let's evaluate

-   And what would a version like this solve for us?

![Hex-based state map](Lecture_12_Hexmap.png){width="636"}

## Gallery

-   There are LOTS of other options out there. For example, [paired plots](ggpubr::ggpaired%20https://rpkgs.datanovia.com/ggpubr/reference/ggpaired.html), Sankey diagrams, path diagrams, etc. etc.
