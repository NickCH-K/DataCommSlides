...
- *As with any computer skill, a teacher's comparative advantage is in letting you know what's out there. The* **real learning** *comes from practice and Googling/prompting. So take what you see here today, find yourself a project, and do it! It will be awful but you will learn an astounding amount by the end*
...
- AI is *pretty* good at data wrangling for small projects
- However, it is *probably a bad idea* to rely on it
- It's much easier for mistakes and misinterpretations to *hide invisibly* in the final product of a data wrangling task
- If you didn't follow, interact, check, and revise *every step of the way* so that you truly *understand* your own data, you didn't do it right
- And if you *are* doing this, it saves you little effort or time to have the AI code for you anyway
...
- (the next few slides are organized into categories. To actually get into them push *up and down*, not left/right)
...
- There are a *lot* of options here that we won't go into. See the [guide](https://stringr.tidyverse.org/articles/regular-expressions.html)
