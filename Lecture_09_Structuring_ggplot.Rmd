...
- Note that `scale_whatever_manual` can also be used to limit or reorder factor variables
- `scale_fill_manual(values = c('Apple'='red','Carrot'='orange', 'Banana'='yellow'))` will go in Apple, Carrot, Banana order
...
-  In a continuous function, say for dollars, `scale_x_continuous(labels = scales::dollar)` would put it in dollar terms
