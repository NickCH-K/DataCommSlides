...
- Another way to avoid identification error is to think about what you're really implying with your results and seeing if it makes sense
...
- For example, if you're trying to develop a successful TV show, you might notice that viewership (success) is positively correlated with the number of seasons a show gets
- But saying "try to get a lot of seasons, that will lead to success" is nonsense - viewership causes seasons, not the other way around
- It's not even useful as a predictor - if you're *developing* the show, you don't *know* how many seasons it will get
- You're not answering the actual question of interest (how do we spot/make a hot TV show?)
